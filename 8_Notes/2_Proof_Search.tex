...
The Twelf project\footnote{http://twelf.org/wiki/Main\_Page} makes use of runtime proof search and has some support for dependent types, but the underlying theory cannot be considered \fullSp{}.
...
The Curry Language\footnote{https://curry.pages.ps.informatik.uni-kiel.de/curry-lang.org/} performs logic programming in a Haskell-like language.
