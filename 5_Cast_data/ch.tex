...
While the lack of a formal \ac{TAS} and \bidir{} system in \ch{4} will make the other properties of \ch{3} difficult to show, we will design the system with an eye twords preserving them.
...
% cast lang
%   operational behavour
% cast sys
%   Defn EQ!!
%   presumed cast soundness
% elaboration
%   unification
%   presumed props
% future work?
...
\todo{sitll some worthwile stuff to extract from the defunct version of this chapter}
