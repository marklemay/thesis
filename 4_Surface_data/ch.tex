...
\ccnote{
 It is really hard to get clean citations around data in dependent type systems.
 everything is muddled, except Martin Lof, some of Coquand and the Zombie papers.
 I don't know of any account of dependent data that is consistent across papers (this includes CIC).
 Having already spent a lot of time trying to track down exactly who was doing what in the 80s and 90s, I feel very uncomfortable adding any specific new citations that will probably be misleading.
 For instance, https://proofassistants.stackexchange.com/questions/1257/what-should-be-cited-for-the-calculus-of-inductive-constructions on just getting a correct citation (or even capitalization) for CIC.
}
