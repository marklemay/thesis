...
Unlike the surface language, it is not longer practical to characterize values syntactically.
...
%% "self evidently correct" sinc it is clear to only extract inequalities. like step and val? one of several possible contrediction extraction relations
\begin{fact}
