...
First we enrich the \slang{} with location information, $\ell$, at every position that could result in a type mismatch in \Fref{surface-pre-syntax-loc}.
