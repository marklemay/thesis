...
In \ch{5} casts will need to be overhauled to support data, and it will be more clear when a cast can through its own error or merely exists to hold other casts.
