...
However, anyone using a dependent type system has already bought into the usefulness of types in general and will probably not want fragments of completely untyped code.
...
One could however characterize this work in this Chapter as gradualizing the definitional equality relation.
