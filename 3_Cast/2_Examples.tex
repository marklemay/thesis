...
If an application happens to\ccnote{I think "to" is right here? as in "we apply 3 to the addition function"} a cast of function type, the argument and body casts are separated and the arguments are swapped.
For instance:
\begin{align*}
...
Applying \ccnote{Do you apply a function to an argument or do you apply an argument to a function?} any type will uncover the error, so we can inspect the term with $\star$.
