...
We can re-examine some of the example terms from \ch{2}, but this time with equality assumptions.
\todo{more intro?}
...
If \Fref{cast-ex-tf} explicitly tracked the location and observation information an error message could be generated:
