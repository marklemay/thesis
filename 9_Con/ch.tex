...
Finally, in \ch{6}, there are several ways to improve the current system and build towards future work: automated testing, runtime proof search and most of all a convenient embedding of effects.
