...
\title{A Dependently Typed Language with Dynamic Equality for Programming}
...
% \newpage
% %\thispagestyle{empty}
% \input{chapters/00_Prelim/quote}
% \cleardoublepage
