...
Because the $\equiv$ relation is usually based on the definition of computation, rather then on observable properties, it is called \textbf{definitional equality}\todo{is that actually why?}\footnote{
