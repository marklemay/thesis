...
Type annotations reflect a correct typing derivation in the $\textrm{ty-::}$\todo{font stuff} rule.
\Tit is recognized by the $\textrm{ty-}\star$ rule.
...
The system of parallel reductions is defined in \Fref{surface-reduction} The only interesting rules are $\textrm{\ensuremath{\Rrightarrow}-fun-app-red}$ and $\textrm{\ensuremath{\Rrightarrow}-::-red}$ since they directly preform reductions.
...
% \begin{tabular}{cccc}
% $max($ & $\left(\mathsf{fun}\,f\,x\Rightarrow m\right)\,n$ & $)=$ & $max\left(m\right)\left[f\coloneqq\mathsf{fun}\,f\,x\Rightarrow max\left(m\right),x\coloneqq max\left(n\right)\right]$ \tabularnewline
...
% \item \textrm{ty-fun-ty} and \textrm{ty-fun} ...
  \item All other cases follow directly or by induction
\end{casenv}
\end{proof}
...
Though these restrictions are not required for type soundness, it will be convenient to exclude these possibilities by adding the following restrictions in \Fref{surface-tas-reg}.
...
Given these restrictions we can conclude.
...
In fact, almost every example in \Fref{surface-examples} has enough annotations to type check bidirectionally without further information.
...
The surface language supports bidirectional type-checking over the pre-syntax with the rules in \Fref{surface-bityping-rules}.
...
In Bidirectional systems, \textbf{annotatability}\footnote{also called \textbf{completeness}} is the property that any expression that types in a \ac{TAS} will type in the bidirectional system with only additional annotations.
...
Instead we can show that the bidirectional system does not preclude any computation available in the \ac{TAS}, though annotations may need to be added (or removed).% no need to remove if properly bidirectional).
...
Coquand implemented an early bidirectional algorithm to type-check a language with \tit\cite{COQUAND1996167}.
...
% https://pdf.sciencedirectassets.com/271596/1-s2.0-S0168007200X00942/1-s2.0-0168007290900443/main.pdf?X-Amz-Security-Token=IQoJb3JpZ2luX2VjEG0aCXVzLWVhc3QtMSJGMEQCIFSli4A8K6FDZecOEBrODsSRQkWf4kVLsAT8ZTE8hsISAiBEQ6Kexg6qllUf926MZuCvcA%2FEFEUozoJnapDBmZQYQCqDBAiW%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F8BEAQaDDA1OTAwMzU0Njg2NSIMofc2RU%2FY4QY5OGCvKtcDR%2FY4Qk%2BOjYeJG9I2d5x%2Fn0hOp%2FQ6dNlKvgQhyjylK40YH4%2BY0Xp%2Fqy%2FqDPT622K87pG05gpAwEaQODVLZMZpSTOAXHeNrIWSwkQz%2FDnAxeh4LG6NC%2Ba78yQvDrImMkXNWixj4UvSnChCnCk1KFNPS4%2BZLDDFIo1JEwX6Ti1co93vfht%2B0q26M50r9IzLYFFX1q1xpBeCOt2Rm8PZ5z0%2F%2FlXbQVqIZzV%2FzoVYwewzobYgkfGsqiAR%2FcSeamDVf9UczzhIWcro7Xxt9PM7xLG4A7j%2F6evpKhY0cMn6RQ%2F8wxR4q5CqBx2RP94zhFvpqQfnwIw4Pw8a6zaOSNArI65woo%2FoovPQPcXdBI5BBqLypyeclSDKjfUaQlt3TjryGp7GRQYu3yQOEshuuYgVHQbermZZ14spwRZyt01U7gEB2tQUVv6uGq28I%2B6XzDIg1EkNJSSQwj2HfOvEvz%2BiurAIeyTASIZZXUp440u0YcUymlZQOeIlbC1aCMUAwmfmrPAEnPpE0UmxmppwEYi%2B4nwkbVot9B3hVncEDv5Tc%2F6YPIBXz5pvzYd7U1dtQbASA1d8yw%2FvS8tkLVk3iSn%2FHMTHN7glTATI%2BxdSUB7FoXukZI0UErmum3RYMIvJwY8GOqYBuD0K83IG8ZJj9sT2sK8%2BExWpzsTyS9NuK9k2%2BIphxvGseCQDOS%2FkZ00Z4%2FoMKGsW5usij33h6iln5RX%2FTVYrJEQWbDwxPqHM%2FTGDXLRMkN2Ni%2FfsMqhje4Tf6fQEqVYnZSCY57XWGOdumXNRK%2Bc9bqt8ULVTi3rm9Ae0h94xbBH0RZ4wIojAP3UUJObFOvOVwtxHcISIR4KZppMEpsegCYFhM1ioBw%3D%3D&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20220125T212203Z&X-Amz-SignedHeaders=host&X-Amz-Expires=300&X-Amz-Credential=ASIAQ3PHCVTY6JCOWDYF%2F20220125%2Fus-east-1%2Fs3%2Faws4_request&X-Amz-Signature=eae79226f4116531e09756602064aacbd78aeb5318627b95ad7cc2664419b4ef&hash=7c1c6924ff3612229d9b08d6152eaaccf1532809166de22361c62f72741c7995&host=68042c943591013ac2b2430a89b270f6af2c76d8dfd086a07176afe7c76c2c61&pii=0168007290900443&tid=spdf-213da1c0-275e-4ffc-b583-87a65c2752b5&sid=f84470ba9318804a1a3b5cd6991bbda08f86gxrqa&type=client
...
% Martin-Liif [10] was brought to our attention, indicating that Martin-Lof more
% than anticipated many of our results. We also thank D