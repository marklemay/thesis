...
$\textrm{ty-fun}$ & \multicolumn{2}{l}{$\Gamma,f:\left(x:N'\right)\rightarrow M',x:N'\vdash m\,:\,M'$, $\left(x:N'\right)\rightarrow M'\equiv\left(x:N\right)\rightarrow M$}\tabularnewline
 & $N'\equiv N,\quad M'\equiv M$ & by stability of $\textrm{ty-fun}$\tabularnewline
 & $\Gamma,f:\left(x:N'\right)\rightarrow M',x:N'\equiv\Gamma,f:\left(x:N\right)\rightarrow M,x:N$ & by reflexivity of $\equiv$ (of contexts), extended with previous
equalities\tabularnewline
