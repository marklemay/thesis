...
% link or cite https://proofassistants.stackexchange.com/questions/1219/has-anyone-ever-accidentally-proven-a-false-theorem-with-type-in-type
...
}\todo{sentence fragments in footnotes} and OCaml modules, make type checking undecidable in those languages).
...
% that will bypass the bidirectional procedure described here.
\todo{then why review?}
