...
$\mathtt{Vec}$ has type dependency since it is a type that depends on its length.
...
While the full spectrum approach offers tradeoffs (it is harder to deal with effects), it seems to be the most predictable from a newcomer's perspective.
