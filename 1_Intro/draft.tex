...
\begin{document}
\title{Chapter 1 (draft): Introduction}
\author{Mark Lemay}
\maketitle
...
in Coq \footnote{available at \href{https://github.com/marklemay/dtest-coq}{https://github.com/marklemay/dtest-coq},
most work is due to Qiancheng Fu}. The system has been prototyped\footnote{available at \href{https://github.com/marklemay/dDynamic}{https://github.com/marklemay/dDynamic}}.
...
file:///Users/stephaniesavir/Downloads/Combining\_proofs\_and\_programs.pdf
...
The ultimate goal being that\textbf{ it should be easier to write
programs with dependent types then without}.

\todo[inline]{Curry HOW}

According to the Curry-Howard correspondence\footnote{Also called...}
types correspond to proposition and proofs correspond to programs.
This gives programmers an unrivaled degree of freedom and precision
when specifying and verifying their code. 

\section{Error msgs}

%% problem
If programmers found dependent type systems easier to learn and use,
software could become more reliable. Unfortunately, dependent type
systems have yet to see widespread use in industry. One source of
difficulty is the conservative equality checking required by most
dependent type systems. This conservative equality is a source of
some of the confusing error messages dependent type systems are known
for \cite{eremondi2019framework}.

This error will help the programmer fix the bug in $\mathtt{add}$.
There is evidence that specific examples like this can help clarify
the type error messages in OCaml \cite{10.1145/2951913.2951915} and
there has been an effort to make refinement type error messages more
concrete in other systems like Liquid Haskell \cite{10.1145/3314221.3314618}.
\end{document}
